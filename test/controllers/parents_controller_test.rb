...
class ParentsControllerTest < ActionController::TestCase
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post :create, parent: { child_name: @parent.child_name, email: @parent.email, parent_name: @parent.parent_name }
    end
  ...
  test "should update parent" do
    patch :update, id: @parent, parent: { child_name: @parent.child_name, email: @parent.email, parent_name: @parent.parent_name }
    assert_redirected_to parent_path(assigns(:parent))
  end
